...
This repository lets you create WCAG EM Reports based on EARL files, for example generated by [Polypane.cloud](https://polypane.cloud). It is based on [Eleventy WCAG Reporter](https://hidde.blog/introducing-an-eleventy-starter-project-for-wcag-reports/) by Hidde de Vries.
